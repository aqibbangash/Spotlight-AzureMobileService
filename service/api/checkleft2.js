...
﻿    var dialog_id = request.body.dialog_id;
    ...
    var thisFn = function(){
        ...
        leftTable.where(function(c_time, u_id, d_id){ return (this.user_id != u_id && this.dialog_id == d_id && (parseFloat(this.timecreated)-c_time)>0 )}, currentTime, user_id, dialog_id).read({
